...
const debug = __webpack_require__(149)('superagent');
const formidable = __webpack_require__(155);
const FormData = __webpack_require__(164);
const Response = __webpack_require__(175);
const parse = __webpack_require__(11).parse;
const format = __webpack_require__(11).format;
const resolve = __webpack_require__(11).resolve;
let methods = __webpack_require__(87);
const Stream = __webpack_require__(15);
const utils = __webpack_require__(86);
const unzip = __webpack_require__(177).unzip;
const extend = __webpack_require__(178);
const mime = __webpack_require__(179);
const https = __webpack_require__(37);
const http = __webpack_require__(22);
const fs = __webpack_require__(21);
const qs = __webpack_require__(89);
const zlib = __webpack_require__(88);
const util = __webpack_require__(3);
const pkg = __webpack_require__(183);
const RequestBase = __webpack_require__(184);
...
exports.agent = __webpack_require__(186);
...
exports.parse = __webpack_require__(188);
...
var original = __webpack_require__(96)
...
var abort = __webpack_require__(82)
  , async = __webpack_require__(81)
  ;
...
var iterate    = __webpack_require__(80)
  , initState  = __webpack_require__(83)
  , terminator = __webpack_require__(84)
  ;
...
var _superagentNoCache = __webpack_require__(34);
...
var _ESE_API = __webpack_require__(36);

var SERVER_API = _interopRequireWildcard(_ESE_API);

var _ESE_STATUS_MAP = __webpack_require__(201);
...
var _Job = __webpack_require__(93);
...
var Server = function (_EventEmitter) {
  ...
  function Server(serverArgs) {
    ...
    _this.address = serverArgs.address;

    /**
     * The server port.
     * @type {number}
     */
    _this.port = serverArgs.port || null;

    /**
     * The API root endpoint.  If none, set to empty string.
     * @type {string}
     */
    _this.APIRoot = serverArgs.APIRoot || SERVER_API.ROOT_PATH;

    /**
     * The protocol to use.
     * @type {string}
     */
    _this.protocol = serverArgs.protocol || 'http';

    /**
     * The server url.
     * @type {string}
     */
    _this.URL = _this.protocol + '://' + _this.address + (_this.port ? ':' + _this.port : '');

    /**
     * The API root url.
     * @type {string}
     */
    _this.rootURL = _this.APIRoot === '' ? _this.URL : [_this.URL, _this.APIRoot].join('/');
    ...
    if (true) {
      ...
      Eventsource = __webpack_require__(51);
    } else {
        ...
        .end(function (err, res) {
          if (res && res.ok) {
            ...
            var serviceList = services.map(function (service) {
              return new _Service2.default(_this2, service.name, service.tasks);
            });
            resolve(serviceList);
          } else {
            var status = err && err.status ? ': ' + err.status : '';
...
try {
  var supportsColor = __webpack_require__(154);
...
var IncomingForm = __webpack_require__(156).IncomingForm;
...
var util = __webpack_require__(3),
    ...
    File = __webpack_require__(157),
    MultipartParser = __webpack_require__(158).MultipartParser,
    QuerystringParser = __webpack_require__(159).QuerystringParser,
...
var asynckit = __webpack_require__(170);
var populate = __webpack_require__(174);
...
module.exports =
{
  parallel      : __webpack_require__(171),
  serial        : __webpack_require__(173),
  serialOrdered : __webpack_require__(85)
};
...
var serialOrdered = __webpack_require__(85);
...
const util = __webpack_require__(3);
const Stream = __webpack_require__(15);
const ResponseBase = __webpack_require__(176);
...
const StringDecoder = __webpack_require__(79).StringDecoder;
const Stream = __webpack_require__(15);
const zlib = __webpack_require__(88);
...
mime.define(__webpack_require__(180));
...
module.exports = {"_from":"superagent@^3.3.2","_id":"superagent@3.8.2","_inBundle":false,"_integrity":"sha512-gVH4QfYHcY3P0f/BZzavLreHW3T1v7hG9B+hpMQotGQqurOvhv87GcMCd6LWySmBuf+BDR44TQd0aISjVHLeNQ==","_location":"/superagent","_phantomChildren":{"ms":"2.0.0"},"_requested":{"type":"range","registry":true,"raw":"superagent@^3.3.2","name":"superagent","escapedName":"superagent","rawSpec":"^3.3.2","saveSpec":null,"fetchSpec":"^3.3.2"},"_requiredBy":["#DEV:/"],"_resolved":"https://registry.npmjs.org/superagent/-/superagent-3.8.2.tgz","_shasum":"e4a11b9d047f7d3efeb3bbe536d9ec0021d16403","_spec":"superagent@^3.3.2","_where":"C:\\Users\\Traininglead\\Documents\\github\\gsf-sdk\\gsf-js-client-sdk","author":{"name":"TJ Holowaychuk","email":"tj@vision-media.ca"},"browser":{"./lib/node/index.js":"./lib/client.js","./test/support/server.js":"./test/support/blank.js"},"bugs":{"url":"https://github.com/visionmedia/superagent/issues"},"bundleDependencies":false,"component":{"scripts":{"superagent":"lib/client.js"}},"contributors":[{"name":"Kornel Lesiński","email":"kornel@geekhood.net"},{"name":"Peter Lyons","email":"pete@peterlyons.com"},{"name":"Hunter Loftis","email":"hunter@hunterloftis.com"}],"dependencies":{"component-emitter":"^1.2.0","cookiejar":"^2.1.0","debug":"^3.1.0","extend":"^3.0.0","form-data":"^2.3.1","formidable":"^1.1.1","methods":"^1.1.1","mime":"^1.4.1","qs":"^6.5.1","readable-stream":"^2.0.5"},"deprecated":false,"description":"elegant & feature rich browser / node HTTP with a fluent API","devDependencies":{"Base64":"^1.0.1","basic-auth-connect":"^1.0.0","body-parser":"^1.18.2","browserify":"^14.1.0","cookie-parser":"^1.4.3","express":"^4.16.0","express-session":"^1.15.6","marked":"^0.3.6","mocha":"^3.5.3","multer":"^1.3.0","should":"^11.2.0","should-http":"^0.1.1","zuul":"^3.11.1"},"engines":{"node":">= 4.0"},"homepage":"https://github.com/visionmedia/superagent#readme","keywords":["http","ajax","request","agent"],"license":"MIT","main":"./lib/node/index.js","name":"superagent","repository":{"type":"git","url":"git://github.com/visionmedia/superagent.git"},"scripts":{"prepare":"make all","test":"make test"},"version":"3.8.2"}
...
const CookieJar = __webpack_require__(92).CookieJar;
const CookieAccess = __webpack_require__(92).CookieAccessInfo;
const parse = __webpack_require__(11).parse;
const request = __webpack_require__(20);
const AgentBase = __webpack_require__(187);
let methods = __webpack_require__(87);
...
exports['application/x-www-form-urlencoded'] = __webpack_require__(189);
exports['application/json'] = __webpack_require__(190);
exports.text = __webpack_require__(191);

const binary = __webpack_require__(192);
...
var _Task = __webpack_require__(198);
...
var Service = function () {
   ...
   */
  function Service(server, serviceName, serviceTaskList) {
    ...
    this.taskNames = null;
    if (serviceTaskList) {
      this.taskNames = serviceTaskList;
    }
  }
  ...
  (0, _createClass3.default)(Service, [{
    ...
    key: 'tasks',
    value: function tasks(noCache) {
      var _this3 = this;

      return new _promise2.default(function (resolve, reject) {
        // Check if we already have our task names
        if (_this3.taskNames !== null && !noCache) {
          var tasks = _this3.taskNames.map(function (taskName) {
...
//# sourceMappingURL=GSF-node.js.map